...
public class VolleyballMVP {
    public static void main(String[] args) {
        ...
        Player p1 = new Player("Gabriela Guimaraes", "Brazil", "Outside Hitter", 87, 28, 43, 10);
        ...
        Predicate<Player> isEfficient = player -> player.positiveMovements > player.errors && player.errors <= 20;
